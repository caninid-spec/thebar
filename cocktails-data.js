/* ══════════════════════════════════════════════════════════════════════════
   ...
   Ordinamento: alfabetico per nome (gestito automaticamente da config.js).
   Per aggiungere un cocktail: inserire l'oggetto in qualsiasi posizione —
   l'ordinamento viene applicato automaticamente al caricamento.
══════════════════════════════════════════════════════════════════════════ */
...
window.COCKTAILS = [
...

  {
    ...
    name: "Amaretto Sour",
    emoji: "🍒",
    tagline: "Il sour all'amaretto reimmaginato da Jeffrey Morgenthaler",
    iba: false, difford: true,
    ibaCategory: null,
    nomadCategory: "classics",
    baseSpirits: ["amaretto"],
    ingredients: ["lemon juice", "egg white", "cask-strength bourbon"],
    taste: ["sweet", "sour", "nutty", "creamy"],
    strength: "medium",
    style: "short",
    serve: "shaken",
    glass: "rocks",
    ice: "large cube",
    garnish: "Ciliegia al maraschino e scorza di limone",
    recipeDifford: {
      ingredients: [
        { amount: "4.5 cl", item: "Amaretto (es. Disaronno)" },
        { amount: "2.25 cl", item: "Bourbon cask-strength (es. Elijah Craig)" },
        { amount: "3 cl", item: "Succo di limone fresco" },
        { amount: "1 cl", item: "Sciroppo di zucchero semplice" },
        { amount: "1", item: "Albume d'uovo (o 3 cl aquafaba)" }
      ],
      method: "Dry shake tutti gli ingredienti senza ghiaccio per 15 secondi per emulsionare l'albume. Aggiungere ghiaccio, shakerare di nuovo con forza. Filtrare in un rocks glass con un cubo grande. Guarnire con ciliegia e scorza.",
      notes: "Il bourbon ad alta gradazione bilancia la dolcezza dell'amaretto. Il dry shake è fondamentale per la schiuma. La ricetta di Morgenthaler ha trasformato questo cocktail da banale a impeccabile."
    },
    description: "La versione di Jeffrey Morgenthaler dell'Amaretto Sour è considerata la reinvenzione più riuscita di un classico inflazionato. L'aggiunta di bourbon cask-strength e l'albume lo rendono bilanciato, complesso e memorabile.",
    history: "Morgenthaler pubblicò la sua ricetta sul suo blog nel 2012, scatenando un vero cambiamento culturale nel mondo dei cocktail. Da allora, questa versione ha sostituito la ricetta originale nel repertorio di quasi ogni bartender serio."
  },
...

  {
    ...
    name: "Blood and Sand",
    emoji: "🥃",
    tagline: "Scotch, vermouth dolce, Cherry Heering e arancia: l'equilibrio impossibile",
    iba: false, difford: true,
    ibaCategory: null,
    nomadCategory: "classics",
    baseSpirits: ["scotch whisky"],
    ingredients: ["cherry heering", "sweet vermouth", "orange juice"],
    taste: ["fruity", "sweet", "smoky", "complex"],
    strength: "medium",
    style: "short",
    serve: "shaken",
    glass: "coupe",
    ...
    recipeDifford: {
      ingredients: [
        { amount: "2.25 cl", item: "Scotch whisky blended" },
        { amount: "2.25 cl", item: "Cherry Heering (liquore alla ciliegia)" },
        { amount: "2.25 cl", item: "Vermouth rosso dolce" },
        { amount: "2.25 cl", item: "Succo di arancia sanguinella fresco" }
      ],
      method: "Shakerare tutti gli ingredienti con abbondante ghiaccio. Filtrare in una coppa ghiacciata. Guarnire con la scorza di arancia.",
      notes: "Le parti uguali sono fondamentali per l'equilibrio. L'arancia sanguinella dà un colore e un sapore più intenso. Il Cherry Heering non è sostituibile: altri liquori alla ciliegia danno risultati inferiori."
    },
    description: "Nato nel 1922 per celebrare il film muto omonimo con Rudolph Valentino, il Blood and Sand è una delle poche ricette in parti uguali che funziona perfettamente. Un miracolo di equilibrio tra ingredienti all'apparenza incompatibili.",
    history: "Pubblicato per la prima volta nel 'Savoy Cocktail Book' del 1930. Il nome richiama le scene del film: Valentino combatteva come torero, con il rosso del sangue e il giallo della sabbia dell'arena — colori ripresi nel bicchiere."
  },
...

  {
    ...
    emoji: "🥂",
    tagline: "Il 'rimedio mattutino' del Savoy: gin, Cointreau e assenzio",
    iba: false, difford: true,
    ibaCategory: null,
    nomadCategory: "classics",
    baseSpirits: ["gin"],
    ingredients: ["cointreau", "lemon juice", "lillet blanc", "absinthe"],
    taste: ["citrus", "herbal", "dry", "complex"],
    strength: "strong",
    style: "short",
    serve: "shaken",
    glass: "coupe",
    ...
    recipeDifford: {
      ingredients: [
        ...
        { amount: "2.25 cl", item: "Cointreau" },
        { amount: "2.25 cl", item: "Lillet Blanc (o Cocchi Americano)" },
        { amount: "2.25 cl", item: "Succo di limone fresco" },
        { amount: "1 spray", item: "Assenzio (per il bicchiere)" }
      ],
      method: "Spruzzare l'assenzio nella coppa ghiacciata e scartare l'eccesso (o usare un atomizzatore). Shakerare gin, Cointreau, Lillet e limone con ghiaccio abbondante. Filtrare nella coppa. Guarnire con scorza di limone.",
      notes: "Harry Craddock nel Savoy Cocktail Book avvertiva: 'Quattro di questi presi in rapida successione vi faranno vedere doppio.' Il Lillet Blanc ha una formula diversa dall'originale Kina Lillet — il Cocchi Americano è il sostituto più fedele."
    },
    description: "Dalla sezione 'Corpse Revivers' del Savoy Cocktail Book (1930), progettato per curare il mal di testa da hangover. Il No. 2 ha oscurato completamente il No. 1 grazie alla sua complessità e freschezza irresistibili.",
    history: "Harry Craddock lo inserì nel Savoy Cocktail Book come 'rimedio mattutino'. Nonostante l'ironia, è un cocktail tecnicamente eccellente che ha resistito quasi un secolo di mode e cambiamenti nel mondo della miscelazione."
  },
...

  {
    ...
    name: "El Diablo",
    emoji: "🌶️",
    tagline: "Tequila, ribes nero e ginger beer: il diavolo messicano",
    iba: false, difford: true,
    ibaCategory: null,
    nomadCategory: "dark",
    baseSpirits: ["tequila"],
    ingredients: ["crème de cassis", "lime juice", "ginger beer"],
    taste: ["fruity", "spicy", "citrus", "sweet"],
    strength: "light",
    style: "long",
    serve: "built",
    glass: "highball",
    ...
    recipeDifford: {
      ingredients: [
        ...
        { amount: "1.5 cl", item: "Crème de cassis" },
        { amount: "1.5 cl", item: "Succo di lime fresco" },
        { amount: "q.b.", item: "Ginger beer per completare" }
      ],
      method: "In un highball con ghiaccio, versare tequila, crème de cassis e lime. Mescolare delicatamente. Completare con ginger beer. Guarnire con una fettina di lime.",
      notes: "Il cassis affonda naturalmente creando un effetto visivo dal rosso al dorato. Non mescolare troppo per mantenere il gradiente. La ginger beer piccante funziona meglio di quella dolce."
    },
    description: "Creato da Trader Vic negli anni Quaranta, El Diablo è rimasto nell'ombra per decenni prima di essere riscoperto. Il contrasto tra la tequila, l'acidità del lime, la dolcezza del ribes e il piccante dello zenzero è semplicemente diabolico.",
    history: "Victor 'Trader Vic' Bergeron lo pubblicò nel suo 'Bartender's Guide' del 1947. Per lungo tempo è stato più popolare in California che nel resto del mondo, ma la riscoperta dei cocktail tiki lo ha riportato sotto i riflettori globali."
  },
...

  {
    ...
    name: "French 75",
    emoji: "🥂",
    tagline: "Il cannone della Prima Guerra: gin, limone e Champagne",
    iba: false, difford: true,
    ibaCategory: null,
    nomadCategory: "aperitivi",
    baseSpirits: ["gin"],
    ingredients: ["lemon juice", "sugar syrup", "champagne"],
    taste: ["citrus", "dry", "sparkling", "elegant"],
    strength: "medium",
    style: "long",
    serve: "shaken",
    glass: "flute",
    ...
    recipeDifford: {
      ingredients: [
        ...
        { amount: "1.5 cl", item: "Succo di limone fresco" },
        { amount: "1 cl", item: "Sciroppo di zucchero semplice" },
        { amount: "7.5 cl", item: "Champagne o spumante brut ghiacciato" }
      ],
      method: "Shakerare gin, limone e sciroppo con ghiaccio. Filtrare in una flûte ghiacciata. Completare delicatamente con Champagne. Guarnire con la scorza di limone.",
      notes: "La variante con cognac al posto del gin è altrettanto classica e fu la versione originale. Il gin dona freschezza erbacea; il cognac aggiunge profondità e rotondità."
    },
    description: "Prende il nome dal cannone da campo francese da 75mm della Prima Guerra Mondiale, famoso per la sua potenza di fuoco. Il cocktail è altrettanto efficace: elegante in apparenza, devastante nella sostanza.",
    history: "Harry MacElhone lo documentò al New York Bar di Parigi nel 1927 nel suo 'Barflies and Cocktails'. La versione con gin è quella che ha resistito al tempo, pur convivendo pacificamente con la variante cognac."
  },
...

  {
    ...
    name: "Gimlet",
    emoji: "🍋",
    tagline: "Gin e lime in forma essenziale: un classico senza tempo",
    iba: false, difford: true,
    ibaCategory: null,
    nomadCategory: "classics",
    baseSpirits: ["gin"],
    ingredients: ["lime juice", "sugar syrup"],
    taste: ["citrus", "dry", "fresh", "sharp"],
    strength: "strong",
    style: "short",
    serve: "shaken",
    glass: "coupe",
    ...
    recipeDifford: {
      ingredients: [
        { amount: "6 cl", item: "Gin London Dry" },
        { amount: "2 cl", item: "Succo di lime fresco" },
        { amount: "1 cl", item: "Sciroppo di zucchero semplice (2:1)" }
      ],
      method: "Shakerare con abbondante ghiaccio. Filtrare in una coppa ghiacciata. Guarnire con una sottile fettina di lime.",
      notes: "La ricetta tradizionale usava Rose's Lime Cordial, ma il succo fresco con sciroppo dà un risultato nettamente superiore. Il gin deve essere di qualità: con soli tre ingredienti, non si nasconde nulla."
    },
    description: "Uno dei sour più puri nella storia della miscelazione. Tre ingredienti, zero compromessi. Il Gimlet è la prova che la semplicità assoluta richiede la tecnica più precisa.",
    history: "Si ritiene che il nome derivi dal tenente sanitario navale Sir Thomas Gimlette, che avrebbe addizionato la razione di gin dei marinai britannici con succo di lime per prevenire lo scorbuto. Popolarizzato nel romanzo 'Il lungo addio' di Raymond Chandler (1953)."
  },

  {
    ...
    emoji: "🌿",
    tagline: "Gin fresco e basilico: il cocktail estivo di Amburgo",
    iba: false, difford: true,
    ibaCategory: null,
    nomadCategory: "light",
    baseSpirits: ["gin"],
    ingredients: ["fresh basil", "lemon juice", "sugar syrup"],
    taste: ["herbal", "fresh", "citrus", "dry"],
    strength: "medium",
    style: "short",
    serve: "shaken",
    glass: "rocks",
    ice: "cubed",
    garnish: "Rametto di basilico fresco",
    recipeDifford: {
      ingredients: [
        { amount: "6 cl", item: "Gin London Dry" },
        { amount: "2.5 cl", item: "Succo di limone fresco" },
        { amount: "1.5 cl", item: "Sciroppo di zucchero semplice (2:1)" },
        { amount: "8-10", item: "Foglie di basilico fresco" }
      ],
      method: "Pestare delicatamente il basilico nello shaker con lo sciroppo. Aggiungere gli altri ingredienti e ghiaccio. Shakerare vigorosamente. Doppia filtrazione in bicchiere rocks con ghiaccio fresco.",
      notes: "Il doppio filtraggio è essenziale per eliminare i frammenti di basilico. Non lesinare sul basilico: la quantità fa la differenza."
    },
    description: "Creato nel 2008 da Jörg Meyer al Le Lion di Amburgo, il Gin Basil Smash è diventato in pochi anni uno dei cocktail più influenti del XXI secolo — semplice, rinfrescante e replicabile a casa con facilità.",
    history: "Jörg Meyer inventò questo drink quasi per caso durante una sessione creativa estiva. La ricetta originale è rimasta invariata: pochi ingredienti, tecnica impeccabile. Oggi è il secondo cocktail più cercato su Difford's Guide."
  },
...

  {
    ...
    name: "Hugo Spritz",
    emoji: "🌸",
    tagline: "Il sorpasso alpino: fiori di sambuco, menta e Prosecco",
    iba: false, difford: true,
    ibaCategory: null,
    nomadCategory: "aperitivi",
    baseSpirits: [],
    ingredients: ["elderflower liqueur", "prosecco", "soda water", "fresh mint", "lime"],
    taste: ["floral", "sweet", "fresh", "light"],
    strength: "light",
    style: "long",
    serve: "built",
    glass: "wine",
    ice: "cubed",
    garnish: "Rametto di menta fresca e fettina di lime",
    recipeDifford: {
      ingredients: [
        { amount: "3 cl", item: "Liquore al fiore di sambuco (es. St-Germain)" },
        { amount: "10 cl", item: "Prosecco brut ghiacciato" },
        { amount: "3 cl", item: "Soda water" },
        { amount: "4-5", item: "Foglie di menta fresca" },
        { amount: "2", item: "Fettine di lime" }
      ],
      method: "In un calice grande con ghiaccio, versare il liquore di sambuco. Aggiungere le foglie di menta e le fettine di lime. Versare delicatamente il Prosecco e la soda. Mescolare leggermente. Guarnire con menta fresca.",
      notes: "Lo St-Germain è il riferimento, ma qualsiasi buon sciroppo o liquore al sambuco funziona. La menta deve essere fresca e non pestata: vuole solo aromatizzare, non dominare. Servire immediatamente per preservare le bollicine."
    },
    description: "Inventato nel 2005 da Roland Gruber a Naturno, in Alto Adige, lo Hugo ha conquistato l'Europa in meno di dieci anni, diventando il simbolo dell'aperitivo leggero e floreale. Nel 2025 è al 46° posto nella classifica mondiale di Difford's.",
    history: "Gruber lo creò come alternativa più leggera e profumata all'Aperol Spritz. Diffusosi prima nelle valli alpine, poi nel nord Europa e nel mondo. Il nome è semplicemente il nome di battesimo che Gruber diede al suo cocktail senza troppo pensarci — e così è rimasto."
  },
...

  {
    ...
    name: "Jungle Bird",
    emoji: "🦜",
    tagline: "Il tiki amaro: rum scuro, Campari e ananas",
    iba: false, difford: true,
    ibaCategory: null,
    nomadCategory: "dark",
    baseSpirits: ["rum"],
    ingredients: ["campari", "pineapple juice", "lime juice", "sugar syrup"],
    taste: ["bitter", "fruity", "tropical", "sweet"],
    strength: "medium",
    style: "long",
    serve: "shaken",
    glass: "highball",
    ice: "crushed",
    garnish: "Fettina di ananas e foglie",
    recipeDifford: {
      ingredients: [
        { amount: "4.5 cl", item: "Rum scuro jamaicano (es. Appleton 12 o Coruba)" },
        { amount: "2 cl", item: "Campari" },
        { amount: "4.5 cl", item: "Succo di ananas fresco" },
        { amount: "1.5 cl", item: "Succo di lime fresco" },
        { amount: "1.5 cl", item: "Sciroppo di zucchero semplice" }
      ],
      method: "Shakerare tutti gli ingredienti con ghiaccio. Filtrare in un highball o tiki mug con ghiaccio tritato.",
      notes: "Il rum jamaicano con le sue note di banana e spezie è fondamentale. Un rum neutro darebbe un risultato piatto. Il Campari lo distingue da tutti gli altri tiki cocktail."
    },
    description: "Nato nel 1978 all'Aviary Bar del Kuala Lumpur Hilton, il Jungle Bird è rimasto oscuro per decenni prima di essere riscoperto dai bartender negli anni 2010. Il suo segreto è l'abbinamento improbabile — e perfetto — tra rum scuro e Campari.",
    history: "Creato da Jeffrey Ong per l'apertura dell'Aviary Bar, rimase quasi dimenticato fino a quando il bartender John Troia lo pubblicò nel 2010 nel libro 'Beachbum Berry Remixed'. Da lì, l'ascesa è stata inarrestabile."
  },
...

  {
    ...
    name: "Old Cuban",
    emoji: "🥂",
    tagline: "Mojito in abito da sera: rum, menta e Champagne",
    iba: false, difford: true,
    ibaCategory: null,
    nomadCategory: "aperitivi",
    baseSpirits: ["rum"],
    ingredients: ["mint", "lime juice", "sugar syrup", "angostura bitters", "champagne"],
    taste: ["fresh", "herbal", "sparkling", "elegant"],
    strength: "medium",
    style: "short",
    serve: "shaken",
    glass: "coupe",
    ice: "none",
    garnish: "Rametto di menta fresco",
    recipeDifford: {
      ingredients: [
        { amount: "4.5 cl", item: "Rum añejo (es. Bacardi 8 o Havana Club 7)" },
        { amount: "2.25 cl", item: "Succo di lime fresco" },
        { amount: "2.25 cl", item: "Sciroppo di zucchero semplice" },
        { amount: "6", item: "Foglie di menta fresca" },
        { amount: "2 dash", item: "Angostura Bitters" },
        { amount: "4.5 cl", item: "Champagne o Cava brut" }
      ],
      method: "Pestare delicatamente le foglie di menta con lo sciroppo. Aggiungere rum, lime e Angostura con ghiaccio. Shakerare bene. Doppia filtrazione in una coppa ghiacciata. Completare con Champagne.",
      notes: "La doppia filtrazione elimina tutti i frammenti di menta, rendendo il drink elegante come un Martini. Il rum añejo con le sue note di vaniglia e spezie è fondamentale."
    },
    description: "Audrey Saunders creò l'Old Cuban nel 2001 al Bemelmans Bar del Carlyle Hotel di New York come risposta sofisticata al Mojito. Il risultato è un cocktail che condivide il DNA con il suo modello ma appartiene a un universo completamente diverso.",
    history: "Audrey Saunders, una delle bartender più influenti della sua generazione, voleva portare la sensibilità della menta e del rum in un contesto di alta miscelazione. L'Old Cuban è rimasto il suo cocktail più celebre e continua ad essere ordinato in tutto il mondo."
  },
...

  {
    ...
    name: "Paloma",
    emoji: "🍋",
    tagline: "Il cocktail nazionale messicano: tequila e pompelmo",
    iba: false, difford: true,
    ibaCategory: null,
    nomadCategory: "light",
    baseSpirits: ["tequila"],
    ingredients: ["grapefruit juice", "lime juice", "agave syrup", "soda water"],
    taste: ["citrus", "fresh", "dry", "bitter"],
    strength: "light",
    style: "long",
    serve: "built",
    glass: "highball",
    ice: "cubed",
    garnish: "Fettina di pompelmo e bordo di sale",
    recipeDifford: {
      ingredients: [
        { amount: "5 cl", item: "Tequila blanco" },
        { amount: "4 cl", item: "Succo di pompelmo rosa fresco" },
        { amount: "1 cl", item: "Succo di lime fresco" },
        { amount: "1 cl", item: "Sciroppo di agave" },
        { amount: "q.b.", item: "Soda water per completare" },
        { amount: "1 pizzico", item: "Sale fino" }
      ],
      method: "In un highball con ghiaccio, versare tequila, succo di pompelmo, lime e sciroppo. Aggiungere il pizzico di sale. Completare con soda e mescolare delicatamente. Guarnire con una fettina di pompelmo.",
      notes: "In Messico si usa spesso Squirt o Fresca al posto del pompelmo fresco. Il succo fresco è nettamente superiore. Il bordo di sale è facoltativo ma consigliato."
    },
    description: "In Messico, la Paloma è più popolare della Margarita. Semplice, rinfrescante e perfettamente bilanciata, è la dimostrazione che la tequila non ha bisogno di triple sec per esprimere il meglio di sé.",
    history: "Le origini esatte sono dibattute, ma il nome — 'colomba' in spagnolo — suggerisce ispirazioni dalla canzone popolare messicana 'La Paloma'. Don Javier Delgado Corona, leggendario barman di La Capilla a Tequila, è spesso citato come il padre della ricetta moderna."
  },
  ...
  {
    id: "picante-de-la-casa",
    name: "Picante de la Casa",
    emoji: "🌶️",
    tagline: "La margarita speziata che ha cambiato i menu di tutto il mondo",
    iba: false, difford: true,
    ibaCategory: null,
    nomadCategory: "classics",
    baseSpirits: ["tequila"],
    ingredients: ["fresh jalapeño", "lime juice", "agave syrup", "cucumber"],
    taste: ["spicy", "citrus", "fresh", "dry"],
    strength: "medium",
    style: "short",
    serve: "shaken",
    glass: "rocks",
    ice: "cubed",
    garnish: "Fetta di cetriolo e rondella di jalapeño",
    recipeDifford: {
      ingredients: [
        { amount: "5 cl", item: "Tequila blanco" },
        { amount: "2.5 cl", item: "Succo di lime fresco" },
        { amount: "1.5 cl", item: "Sciroppo di agave" },
        { amount: "3", item: "Rondelle di jalapeño fresco (semi rimossi)" },
        { amount: "3", item: "Fette di cetriolo fresco" }
      ],
      method: "Pestare delicatamente jalapeño e cetriolo con lo sciroppo di agave. Aggiungere tequila e lime con ghiaccio. Shakerare bene. Doppia filtrazione in rocks glass con ghiaccio fresco.",
      notes: "Il piccante dipende dalla quantità di jalapeño e da quanto a lungo si pesta. Per calibrarlo, iniziare con 2 rondelle. I semi aumentano il piccante in modo esponenziale."
    },
    description: "Nato al Soho House di Miami come house cocktail nel 2020, il Picante de la Casa ha innescato la grande ondata dei cocktail speziati che ha dominato i menu degli anni Venti. Cucina messicana, freschezza tropicale, calore persistente.",
    history: "Il Soho House lo sviluppò come risposta alla domanda crescente di cocktail speziati. In soli cinque anni è diventato il 9° cocktail più consultato su Difford's Guide — un record per un cocktail così recente."
  },
...

  {
    ...
    name: "Pisco Sour",
    emoji: "🥚",
    tagline: "Il cocktail nazionale di Perù e Cile: pisco, lime e schiuma",
    iba: false, difford: true,
    ibaCategory: null,
    nomadCategory: "classics",
    baseSpirits: ["pisco"],
    ingredients: ["lime juice", "sugar syrup", "egg white", "angostura bitters"],
    taste: ["citrus", "sour", "creamy", "fresh"],
    strength: "medium",
    style: "short",
    serve: "shaken",
    glass: "coupe",
    ice: "none",
    garnish: "3 gocce di Angostura Bitters sulla schiuma",
    recipeDifford: {
      ingredients: [
        { amount: "6 cl", item: "Pisco (peruano o cileno)" },
        { amount: "3 cl", item: "Succo di lime fresco" },
        { amount: "2 cl", item: "Sciroppo di zucchero semplice" },
        { amount: "1", item: "Albume d'uovo (o 3 cl aquafaba)" }
      ],
      method: "Dry shake tutti gli ingredienti senza ghiaccio per 15 secondi. Aggiungere ghiaccio e shakerare di nuovo con forza. Filtrare in una coppa. Decorare con tre gocce di Angostura sulla schiuma.",
      notes: "Il dry shake è essenziale per la schiuma densa e stabile. Le gocce di Angostura non sono solo decorative: aggiungono complessità aromatica. Il pisco peruano è più morbido, quello cileno più fruttato e agrumato."
    },
    description: "Al centro di una disputa diplomatica tra Perù e Cile per la paternità del distillato e del cocktail, il Pisco Sour è uno degli esempi più riusciti di sour con albume d'uovo. La schiuma densa e le gocce di Angostura lo rendono inconfondibile.",
    history: "Victor Vaughen Morris, un bartender americano trapiantato a Lima, lo avrebbe creato negli anni Venti al suo Morris Bar. La ricetta fu poi perfezionata e codificata dal barman Mario Bruiget. Oggi il 6 febbraio è il 'Giorno Nazionale del Pisco Sour' in Perù."
  },
...

  {
    ...
    name: "Southside",
    emoji: "🌿",
    tagline: "Il cugino di Chicago del Gimlet: gin, menta e limone",
    iba: false, difford: true,
    ibaCategory: null,
    nomadCategory: "classics",
    baseSpirits: ["gin"],
    ingredients: ["mint", "lemon juice", "sugar syrup"],
    taste: ["herbal", "citrus", "fresh", "dry"],
    strength: "strong",
    style: "short",
    serve: "shaken",
    glass: "coupe",
    ...
    recipeDifford: {
      ingredients: [
        ...
        { amount: "2.5 cl", item: "Succo di limone fresco" },
        { amount: "2 cl", item: "Sciroppo di zucchero semplice" },
        { amount: "8-10", item: "Foglie di menta fresca" }
      ],
      method: "Pestare delicatamente le foglie di menta con lo sciroppo. Aggiungere gin, limone e ghiaccio abbondante. Shakerare vigorosamente. Doppia filtrazione in coppa ghiacciata.",
      notes: "La differenza con il Mojito è sostanziale: nessuna soda, nessun rum, nessuna costruzione nel bicchiere. È un sour classico con la menta come protagonista aromatica, non strutturale."
    },
    description: "Associato al South Side di Chicago degli anni Venti, quando i contrabbandieri del proibizionismo usavano la menta per mascherare il sapore del gin di scarsa qualità. Oggi, con gin di qualità, la menta è una scelta puramente aromatica.",
    history: "Rivendicato sia da Chicago (South Side) che da Long Island (Southside Club). La versione più accreditata lo colloca nel contesto del proibizionismo americano, anche se il cocktail era già conosciuto in precedenza nei club dell'élite."
  },
...

  {
    ...
    name: "Tom Collins",
    emoji: "🥤",
    tagline: "Il long drink vittoriano che ha definito un'intera categoria",
    iba: false, difford: true,
    ibaCategory: null,
    nomadCategory: "light",
    baseSpirits: ["gin"],
    ingredients: ["lemon juice", "sugar syrup", "soda water"],
    taste: ["citrus", "fresh", "dry", "light"],
    strength: "light",
    style: "long",
    serve: "built",
    glass: "highball",
    ice: "cubed",
    garnish: "Fettina di limone e ciliegia",
    recipeDifford: {
      ingredients: [
        { amount: "4.5 cl", item: "Gin Old Tom o London Dry" },
        { amount: "3 cl", item: "Succo di limone fresco" },
        { amount: "1.5 cl", item: "Sciroppo di zucchero semplice" },
        { amount: "q.b.", item: "Soda water fredda per completare" }
      ],
      method: "In un highball ghiacciato, versare gin, succo di limone e sciroppo. Mescolare delicatamente. Completare con soda. Guarnire con limone e ciliegia.",
      notes: "La ricetta originale usava Old Tom Gin, leggermente più dolce del London Dry. Oggi la maggior parte dei bartender usa London Dry con proporzioni identiche. La soda deve essere ben fredda e aggiunta all'ultimo."
    },
    description: "Il Tom Collins ha dato il nome a un'intera famiglia di cocktail: ogni sour allungato con soda in un highball è, tecnicamente, un 'Collins'. Fresco, dissetante e quasi infinitamente declinabile.",
    history: "Il cocktail prende il nome da un omonimo burlone del 1874: a New York era di moda dire ai propri amici che un tale 'Tom Collins' li stava insultando in un bar vicino. La trovata diventò virale — talmente popolare che il cocktail fu creato per cavalcarla."
  },
